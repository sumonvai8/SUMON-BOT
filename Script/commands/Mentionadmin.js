...
module.exports.handleEvent = function({ api, event }) {
 const adminIDs = ["61586724548553", "61588088152075", "61586724548553"].map(String); //update your UID✅
 ...
 "মেনশন দিয়ে লাভ নাই বস সুমন এখন বিজি আছেন😗😘"
 ];
